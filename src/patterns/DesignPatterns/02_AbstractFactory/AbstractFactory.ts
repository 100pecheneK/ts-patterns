export default function AbstractFactory() {
  ...
  function clientCode(factory: AbstractFactory) {
    ...
    console.log('productA.usefulFunctionA(): ', productA.usefulFunctionA())
    console.log('productB.usefulFunctionB(): ', productB.usefulFunctionB())
    console.log(
   ...
   */
  console.log('start new ConcreteFactory1()')
  clientCode(new ConcreteFactory1())
  console.log('---')
  console.log('start new ConcreteFactory2()')
